...
export default function EditDeleteQuestions(value: any) {
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full text-center flex flex-col justify-center gap-8">
                        ...
                        <div className="flex gap-5 justify-center">
                            ...
                            <button onClick={() => {deletequestion(value.value) ;location.reload()}} className=" bg-red-500 text-white px-4 py-2 rounded">
                                Deletar
                            </button>
                        </div>
                    </div>
